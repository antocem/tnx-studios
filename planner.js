(function(){
    ...
    if(vsRows){
      vsRows.innerHTML=cmp.ok
        ? '<div class="cvsRow trad"><span>'+num(TR.sessions)+' filming sessions</span><b>'+money0e(TR.shootCost)+'</b></div>'+
          ...
          '<div class="cvsRow tnxr"><span>TNX, same output</span><b>'+money0(T.priceUsd)+' &#183; '+num(T.days)+'d</b></div>'
  ...
  function paintProposal(T,TR,PB,cmp){
    ...
    $('cPropTitle').textContent='TNX Content System for a '+ind.name+' brand';
    $('cPropMeta').innerHTML=[
    ...
    $('cCompare').innerHTML=
      ...
      '<div class="ccol tnx">'+
        '<div class="ccolHead"><span class="cvsIco" style="background:rgba(140,255,61,.13);border-color:rgba(140,255,61,.3);color:var(--lime)">'+ICO.spark+'</span><b>TNX content system</b></div>'+
